...
interface ChallengeResourcesModalProps {
  open: boolean;
...
export function ChallengeResourcesModal({
  open,
  onOpenChange,
  challenge,
  onContinue,
}: ChallengeResourcesModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto" data-testid="modal-challenge-resources">
        <DialogHeader>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <DialogDescription className="text-lg">
                These organizations can help you with this challenge
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-end gap-3">
            <Button
              ...
              onClick={onContinue}
              data-testid="button-continue-challenge"
            >
